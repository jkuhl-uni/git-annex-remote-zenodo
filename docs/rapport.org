...
*** historique / gros fichiers (1 page).
    - Dans la recherche scientifique, on travaille sur des milliers de
      ...
      développement de la recherche et donc pour suivre et comprendre
      tous les pas de l'expérience. C'est pour raison que l'on se sert
    ...
    - Mais git-annex n'est pas le seul outil existant qui permet la
      ...
      y a des problème avec cet outil qui gênent son utilisation:
