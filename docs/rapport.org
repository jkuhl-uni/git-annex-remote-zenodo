...
implémentée, il fallait utiliser l’API de Zenodo. La première partie
du procès donc est de comprendre comment elle fonctionne et de tester
ses fonctionnalités. On a fait donc des tests pour chacune des
requêtes HTTP pour tester les opérations possibles Zenodo.
