...
print(json.dumps(r.json(), indent=4))
   ...
   #+RESULTS:
   : 201
   : {'conceptrecid': '844900', 'created': '2021-06-01T12:36:32.719368+00:00', 'files': [], 'id': 844901, 'links': {'bucket': 'https://sandbox.zenodo.org/api/files/c478c95e-ab64-43d6-b804-98570439ee36', 'discard': 'https://sandbox.zenodo.org/api/deposit/depositions/844901/actions/discard', 'edit': 'https://sandbox.zenodo.org/api/deposit/depositions/844901/actions/edit', 'files': 'https://sandbox.zenodo.org/api/deposit/depositions/844901/files', 'html': 'https://sandbox.zenodo.org/deposit/844901', 'latest_draft': 'https://sandbox.zenodo.org/api/deposit/depositions/844901', 'latest_draft_html': 'https://sandbox.zenodo.org/deposit/844901', 'publish': 'https://sandbox.zenodo.org/api/deposit/depositions/844901/actions/publish', 'self': 'https://sandbox.zenodo.org/api/deposit/depositions/844901'}, 'metadata': {'prereserve_doi': {'doi': '10.5072/zenodo.844901', 'recid': 844901}}, 'modified': '2021-06-01T12:36:32.719377+00:00', 'owner': 72937, 'record_id': 844901, 'state': 'unsubmitted', 'submitted': False, 'title': ''}
   : {'mimetype': 'application/pdf', 'updated': '2021-06-01T12:36:33.063621+00:00', 'links': {'self': 'https://sandbox.zenodo.org/api/files/c478c95e-ab64-43d6-b804-98570439ee36/AirPollutionInGrenoble.pdf', 'version': 'https://sandbox.zenodo.org/api/files/c478c95e-ab64-43d6-b804-98570439ee36/AirPollutionInGrenoble.pdf?versionId=3d8c6cb2-dc2a-4e3a-b1ba-587e3d1eb686', 'uploads': 'https://sandbox.zenodo.org/api/files/c478c95e-ab64-43d6-b804-98570439ee36/AirPollutionInGrenoble.pdf?uploads'}, 'is_head': True, 'created': '2021-06-01T12:36:33.053981+00:00', 'checksum': 'md5:96379d6f2dfdbdd68ee0fa48a31ee07c', 'version_id': '3d8c6cb2-dc2a-4e3a-b1ba-587e3d1eb686', 'delete_marker': False, 'key': 'AirPollutionInGrenoble.pdf', 'size': 1107977}
   : 401
   : {
   :     "message": "The server could not verify that you are authorized to access the URL requested. You either supplied the wrong credentials (e.g. a bad password), or your browser doesn't understand how to supply the credentials required.",
   :     "status": 401
...
r = requests.post('https://sandbox.zenodo.org/api/deposit/depositions/%s/actions/newversion?access_token=kBs8SX4CBQmUQb3ygRn3HkmZNgDoIGzYzdW2wuuBv5xQpQmZ2zzJo6iql7fY' % bucket_id, json={} , headers={"Content-Type": "application/json"})
print(r.status_code)
print(json.dumps(r.json(), indent=4))
