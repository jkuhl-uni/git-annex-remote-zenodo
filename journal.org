...
*** Renaming using the edit action: non functionnal. 
...
def publish():
    ...
    bucket_id = 851823  # we get this by choosing the id of one of the deposits we created
    ...
    if upload_type == 'publication':
        ...
        print("15 - other \n")
        n = int(input())
        publication_type = publicationtypes[n]
